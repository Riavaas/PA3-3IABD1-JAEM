...
def remplir_raw_depuis_drive(raw_dir, drive_root_folder_name, credentials_path, token_path):
    """
    Télécharge depuis My Drive/{drive_root_folder_name}/{hello_kitty|sanrio_other|other}
    vers datasets/raw.
    """
...
def main():
    ...
    # Par défaut: télécharger depuis Google Drive (dataset/hello_kitty|sanrio_other|other).
